...
### RNN Projects
- Implemented Recurrent Neural Networks (RNN) for:
  - Text generation
  - Sentiment analysis
...
- Performed sentiment classification on IMDb movie review dataset
...
- Converted text data into numerical form using:
  ...
  - Tokenization + embeddings (for DL models)
...
- Compared performance between ML and DL models using accuracy and confusion matrices
- Observed that LSTM performs better in capturing sequential patterns in text
